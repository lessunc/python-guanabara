...
#  dicionário, cadastrando também o ano de contratação e o salário no caso da CTPS ser
#  maior que 0. Calculando e acresentando  ainda a idade atual e idade na aposentadoria.
#--------------------------------------------------------------------------------------
